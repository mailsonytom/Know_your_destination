...
<body style="background-image: url('../assets/img/about-bg.jpg'); background-size: cover;">
  ...
  ============================-->
    ...
    <div class="container col-md-8 pt-5 pb-5" style="min-height: 100vh;">
                    ...
                    <tbody>
                        ...
                        <?php foreach ($non_approved_bookings as $a) { ?>
                            <tr>
                                ...
                                <td>
                                    <a href="reject.php?id=<?php echo $a['id']; ?>"><button class="btn btn-danger">Reject</button></a>
                                </td>
                            </tr>
                        <?php } ?>
            ...
            <div class="tab-pane fade" id="reject" role="tabpanel" aria-labelledby="reject-tab">
                <table class="table table-dark">
                    ...
                    <tbody>
                        ...
                        <?php foreach ($rejected_bookings as $a) { ?>
                            <tr>
                                <td><?php echo $a['name'] ?></td>
                                <td><?php echo $a['from_date'] ?></td>
                                <td><?php echo $a['to_date'] ?></td>
