...
<head>
	<meta charset="utf-8">
	<title>Know your destination - Admin Signin</title>
...
<body style="background-image: url('../assets/img/about-bg.jpg'); background-size: cover;">
  ...
  ============================-->
	...
	<div class="container col-md-6 rounded mt-5 p-4 bg-dark">
		<form action="" method="POST" class="mt-5 bg-dark" style="color: #fff;">
			<div align="center">
				<h2>Admin Signin </h2>
			</div>
